...
export default function CisterneGruppoDueEng() {
    ...
    const UmiditàBassa =     <Alert className={classes.alert} variant="filled" severity="warning" icon={<OpacityIcon className={classes.black}/>}><strong>Low Humidity</strong></Alert>
