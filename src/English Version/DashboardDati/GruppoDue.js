                        ...
                        <div className="tab_el">
                            <div>
                                ...
                                <div className={classes.root}>
                                    ...
                                    >
                                        <Tab label="Tank 4" {...a11yProps(0)} className={classes.tab}/>
                                        <Tab label="Tank 5" {...a11yProps(1)} className={classes.tab}/>
                                        <Tab label="Tank 6" {...a11yProps(2)} className={classes.tab}/>
                                        <Tab label="Tank 7" {...a11yProps(3)} className={classes.tab}/>
                                    </Tabs>
                                </div>
                            </div>
                        </div>
...
export default withRouter(RecapGroupTwoEng);