                        ...
                        <div className="tab_el">
                            <div>
                                ...
                                <div className={classes.root}>
                                    ...
                                    >
                                        <Tab label="Tank 1" {...a11yProps(0)} className={classes.tab}/>
                                        <Tab label="Tank 2" {...a11yProps(1)} className={classes.tab}/>
                                        <Tab label="Tank 3" {...a11yProps(2)} className={classes.tab}/>
                                    </Tabs>
                                </div>
                            </div>
                        </div>
...
export default withRouter(RecapGroupOneEng);