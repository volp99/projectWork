                        ...
                        <div key={item.id}>
                            ...
                            <Typography component="div"  style={TypoStyle}>
                                <div className="site-card-border-less-wrapper">
                                    <Card title=  {item.CisternaDue.temperatura.titleeng} bordered={false} style={CardStyle}  elevation={80}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaDue.pressione.titleeng} bordered={false} style={CardStyle}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaDue.umidità.titleeng} bordered={false} style={CardStyle} >
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaDue.livello.titleeng} bordered={false} style={CardStyle} >
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <FaThermometerFull style={{fontSize: "20px"}} /> {item.CisternaDue.temperatura.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <OpacityIcon  style={{fontSize: "20px"}}/> {item.CisternaDue.umidità.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <SiMattermost/> {item.CisternaDue.pressione.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <FaPercent/> {item.CisternaDue.livello.titleeng}</span>
