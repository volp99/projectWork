                        ...
                        <div key={item.id}>
                            ...
                            <Typography component="div"  style={TypoStyle}>
                                <div className="site-card-border-less-wrapper">
                                    <Card title=  {item.CisternaQuattro.temperatura.titleeng} bordered={false} style={CardStyle}  elevation={80}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaQuattro.pressione.titleeng} bordered={false} style={CardStyle}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaQuattro.umidità.titleeng} bordered={false} style={CardStyle} >
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaQuattro.livello.titleeng} bordered={false} style={CardStyle} >
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <FaThermometerFull style={{fontSize: "20px"}} /> {item.CisternaQuattro.temperatura.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <OpacityIcon  style={{fontSize: "20px"}}/> {item.CisternaQuattro.umidità.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <SiMattermost/> {item.CisternaQuattro.pressione.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <FaPercent/> {item.CisternaQuattro.livello.titleeng}</span>
