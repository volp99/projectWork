                        ...
                        <div key={item.id}>
                            ...
                            <Typography component="div"  style={TypoStyle}>
                                <div className="site-card-border-less-wrapper">
                                    <Card title=  {item.CisternaSette.temperatura.titleeng} bordered={false} style={CardStyle}  elevation={80}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaSette.pressione.titleeng} bordered={false} style={CardStyle}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaSette.umidità.titleeng} bordered={false} style={CardStyle} >
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaSette.livello.titleeng} bordered={false} style={CardStyle} >
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <FaThermometerFull style={{fontSize: "20px"}} /> {item.CisternaSette.temperatura.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <OpacityIcon  style={{fontSize: "20px"}}/> {item.CisternaSette.umidità.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <SiMattermost/> {item.CisternaSette.pressione.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <FaPercent/> {item.CisternaSette.livello.titleeng}</span>
