                        ...
                        <div key={item.id}>
                            ...
                            <Typography component="div"  style={TypoStyle}>
                                <div className="site-card-border-less-wrapper">
                                    <Card title=  {item.CisternaCinque.temperatura.titleeng} bordered={false} style={CardStyle}  elevation={80}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaCinque.pressione.titleeng} bordered={false} style={CardStyle}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaCinque.umidità.titleeng} bordered={false} style={CardStyle} >
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaCinque.livello.titleeng} bordered={false} style={CardStyle} >
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <FaThermometerFull style={{fontSize: "20px"}} /> {item.CisternaCinque.temperatura.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <OpacityIcon  style={{fontSize: "20px"}}/> {item.CisternaCinque.umidità.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <SiMattermost/> {item.CisternaCinque.pressione.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <FaPercent/> {item.CisternaCinque.livello.titleeng}</span>
