                        ...
                        <div key={item.id}>
                            ...
                            <Typography component="div"  style={TypoStyle}>
                                <div className="site-card-border-less-wrapper">
                                    <Card title=  {item.CisternaSei.temperatura.titleeng} bordered={false} style={CardStyle}  elevation={80}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaSei.pressione.titleeng} bordered={false} style={CardStyle}>
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaSei.umidità.titleeng} bordered={false} style={CardStyle} >
                                ...
                                <div className="site-card-border-less-wrapper">
                                    <Card title={item.CisternaSei.livello.titleeng} bordered={false} style={CardStyle} >
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <FaThermometerFull style={{fontSize: "20px"}} /> {item.CisternaSei.temperatura.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <OpacityIcon  style={{fontSize: "20px"}}/> {item.CisternaSei.umidità.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <SiMattermost/> {item.CisternaSei.pressione.titleeng}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <FaPercent/> {item.CisternaSei.livello.titleeng}</span>
