    ...
    return (
        ...
        <div className="App">
            <AppBar position="sticky" className={classes.header}>
                <Toolbar>
                    <Typography variant="button"  onClick={() => changePage('/dashboard-eng')}><h3 className={classes.dashboard} >dashboard</h3></Typography>
                    ...
                    <Typography variant="button" className={classes.left}><SupportoDashboardDati/></Typography>
                        <Typography variant="button" onClick={() => changePage('/Home-eng')}><HomeIcon style={{ fontSize: 40 }}/></Typography>
                </Toolbar>
            </AppBar>
        </div>
    );
