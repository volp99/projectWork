...
const CisternaUnoManagement = () => {
    ...
    const {
        ...
        isLoading2,
        error2
    } = useFetch("http://localhost:8000/CisternaUnoSoglie", "GET")
                    ...
                    {(data).map(item => (
                        <div key={item.id}>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="icon-limit"> <FaThermometerFull style={{fontSize: "20px"}} /> {item.CisternaUno.temperatura.title}</span>
                                <span id="min-limit1">Min: {item.CisternaUno.temperatura.minima}{tempVal}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="icon-limit">  <OpacityIcon  style={{fontSize: "20px"}}/> {item.CisternaUno.umidità.title}</span>
                                <span id="min-limit2">Min: {item.CisternaUno.umidità.minima}{umiVal}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="icon-limit2"> <SiMattermost/> {item.CisternaUno.pressione.title}</span>
                                <span id="min-limit3">Min: {item.CisternaUno.pressione.minima}{presVal}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="icon-limit2">  <FaPercent/> {item.CisternaUno.livello.title}</span>
                                <span id="min-limit4">Min: {item.CisternaUno.livello.minima}{liveVal}</span>
                            ...
                            <div className="soglia-rossa">
                                ...
                                <p>Valore minimo: <InputNumber min={0} max={100} defaultValue={item.CisternaUno.temperatura.minima} onChange={onChange}/></p>
                                <p>Valore massimo: <InputNumber min={0} max={100} defaultValue={item.CisternaUno.temperatura.massima} onChange={onChange}/></p>
                            </div>
...
export default CisternaUnoManagement;