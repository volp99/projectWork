                    ...
                    {data.map(item => (
                        <div key={item.id}>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <FaThermometerFull style={{fontSize: "20px"}} /> {item.CisternaTre.temperatura.title}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <OpacityIcon  style={{fontSize: "20px"}}/> {item.CisternaTre.umidità.title}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data"> <SiMattermost/> {item.CisternaTre.pressione.title}</span>
                            ...
                            <Paper elevation={3} id="cisterna_soglia">
                                <span id="data">  <FaPercent/> {item.CisternaTre.livello.title}</span>
