...
const Circle=({stato=50,min=0,rossoGiallo=10,gialloVerde=20,verdeGiallo=80,gialloRosso=90,max=100})=> {
                ...
                <svg viewBox="0 0 150 150">
                    ...
                    >
                        {/* <animateTransform attributeName="transform"
                          attributeType="XML"
                          type="rotate"
                          from={(-150+(300*((max-min)/2-min)/(max-min)))+" 75 75"}
                          to={(-150+(300*(stato-min)/(max-min)))+" 75 75"}
                          dur="0.5s"
                          repeatCount="1"/> */}
                    </polygon>
                </svg>
